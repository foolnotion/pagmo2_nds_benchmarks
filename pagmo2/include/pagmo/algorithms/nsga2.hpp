...
public:
    ...
    nsga2(unsigned gen = 1u, double cr = 0.95, double eta_c = 10., double m = 0.01, double eta_m = 50.,
          ...
          non_dominated_sorting_algorithm nds_algorithm = non_dominated_sorting_algorithm::NDS,
          bool dominate_on_equal = false);
...
private:
    ...
    unsigned m_seed;
    non_dominated_sorting_algorithm m_nds_algorithm;
    bool m_dominate_on_equal;
