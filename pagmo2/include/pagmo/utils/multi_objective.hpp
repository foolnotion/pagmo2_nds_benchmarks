...
PAGMO_DLL_PUBLIC std::vector<pop_size_t> select_best_N_mo(const std::vector<vector_double> &, pop_size_t, non_dominated_sorting_algorithm alg = non_dominated_sorting_algorithm::NDS, bool dominate_on_equal = false);
